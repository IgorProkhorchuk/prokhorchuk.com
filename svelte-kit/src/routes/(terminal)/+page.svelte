...
<div class="header">
	<h1 class="main-title">
		igor@prokhorchuk.com<span class="prompt">:~$</span>
...
<div class="section">
	<p>
		<span class="prompt">$</span> sudo find /home/igor/projects -type d -name
		"current" -exec ls -l &#123;&#125; \\;
	</p>
	<ul>
...
<div class="section">
	...
	<ul>
		<li>
			...
			<a href="mailto:igor@prokhorchuk.com" class="linkContacts"
				>igor@prokhorchuk.com</a
			>
		</li>
		<li>
